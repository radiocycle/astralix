...
_MODULE_FRAME_RE = re.compile(r"astralix\.modules\.([\w.]+)")
...
class APIRatelimiterMod(loader.Module):
    ...
    async def _install_protection(self):
        ...
        if getattr(self._client._call, "_astralix_overwritten", False):
        ...
        self._client._call._astralix_overwritten = True
