...
@loader.tds
class astralixConfigMod(loader.Module):
    """Interactive configurator for astralix Userbot"""

    strings = {"name": "astralixConfig"}
    ...
    def _category_option(
        ...
        if option in astralixConfigMod._config_categories(instance).get(category, []):
            return option
