...
class CoreMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/astralix/astralix_cmd.png",
                "Banner image URL for .astralix command",
    ...
    async def installationcmd(self, message: Message):
        ...
        if (
            ...
            await self.inline.form(
                ...
                photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/astralix/astralix_installation.png",
            )
        ):

            await self.client.send_file(
                message.peer_id,
                "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/astralix/astralix_installation.png",
