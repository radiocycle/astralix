...
class Quickstart(loader.Module):
    ...
    async def client_ready(self):
        ...
        try:
            ...
            existing_channel_id = self.db.get("astralix.forums", "channel_id", None)
            ...
            if existing_channel_id:
                try:
                    ...
                    content_channel = None
                    self.db.set("astralix.forums", "forums_cache", {"astralix-userbot": {}})
            ...
            if not content_channel:
                async for dialog in self.client.iter_dialogs():
                    if dialog.title and "astralix-userbot" in dialog.title.lower():
                        ...
                        self.db.set(
                            "astralix.forums", "channel_id", int(dialog.entity.id)
                        )
                        break
            ...
            forum_entity = None
            existing_forum_id = self.db.get("astralix.forums", "forum_id", None)
