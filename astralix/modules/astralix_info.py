...
class astralixInfoMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/astralix/astralix_info.png",
    ...
    async def _render_info(self, start: float) -> str:
        ...
        data = {
            ...
            "tl_version": telethon.__version__,
        ...
        return (
            ...
            if self.config["custom_message"]
                ...
                (
                    ...
                    if self._client.astralix_me.premium and self.config["show_astralix"]
                    else ""
                ),
                me=me,
                version=_version,
