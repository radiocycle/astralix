...
> Хотя astralix реализует расширенные меры безопасности, установка модулей от ненадежных разработчиков все еще может нанести вред вашему серверу/аккаунту.
> 
> Рекомендации:
...
| Тип | Ссылка |
|------|-------|
| Пользовательская документация | [astralix-ub.xyz](https://astralix-ub.xyz/) |
| Документация для разработчиков | [dev.astralix-ub.xyz](https://dev.astralix-ub.xyz/) |

---

## 💬 Поддержка

[![Поддержка Telegram](https://img.shields.io/badge/Telegram-Support_Group-2594cb?logo=telegram)](https://t.me/astralix_talks)
...
- [Lonami](https://t.me/lonami) за Telethon (основа astralix-TL)
